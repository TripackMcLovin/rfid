...
/**
 * Constructor with adjustable SPI Port
 * to be used on MCU with more than one SPI port and to select the port
 * be used with for the reader
 * e.g. the STM32F103C with another port (SPI_2)
 * on
 *   	SCK2 = PB13
 *   	SS2  = PB12
 *   	MOSI2 = PB14
